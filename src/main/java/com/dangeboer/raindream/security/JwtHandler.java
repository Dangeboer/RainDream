...
public class JwtHandler {
    ...
    public JwtHandler(@Value("${raindream.jwt.secret-key}") String secretKey) {
    ...
    public String generateToken(String username) {
        return Jwts.builder()
                ...
                .setExpiration(new Date(System.currentTimeMillis() + 1000 * 60 * 60 * 24 * 7)) // 设置 JWT 的过期时间，这里设置为签发后 24 小时 * 7（7天）
